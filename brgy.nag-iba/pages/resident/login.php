...
?>
    ...
    <body class="skin-black" style="background: url(../../pages/resident/image/bg.jpg); background-size: cover; height: 100vh;">
        <div class="container" style="margin-top:55px; ">
          <div class="col-md-4 col-md-offset-4" >
              <div class="panel panel-default" style="box-shadow: 0 2px 10px 2px black; ">
            <div class="panel-heading" style="text-align:center; background-color: #00897b;">
                <img src="../../pages/resident/image/flogo(1).png" style="height:150px;"/>
            ...
            <div class="panel-body">
              <form role="form" method="post">
				...
				<button type="submit" class="btn btn-sm btn-primary" name="btn_exit" style="float: right;">Exit</button>
      ...
      <?php
		...
		header ('location: ../../../../bmis/main/biismmorg.php');
