...
if(isset($_POST['btn_add'])){
    ...
    if($ct == 0){
        $query = mysqli_query($con,"INSERT INTO tblzone (name,username,password) 
...
if(isset($_POST['btn_save']))
{
    ...
    if($ct == 0){
        $update_query = mysqli_query($con,"UPDATE tblzone set name = '".$txt_edit_name."', username = '".$txt_edit_uname."', password = '".$txt_edit_pass."' where id = '".$txt_id."' ") or die('Error: ' . mysqli_error($con));
