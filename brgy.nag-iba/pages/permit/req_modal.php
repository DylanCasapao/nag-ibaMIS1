                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="ddl_tob" class="form-control input-sm">
                                        ...
                                        <option value="Option 1">Sari-Sari Store</option>
                                        <option value="Option 2">Cellphone Loading Business</option>
                                        <option value="Option 3">Printing Business</option>
                                        <option value="Option 4">Rice Retailing Business</option>
                                        <option value="Option 5">Beauty Products Reselling Business</option>
                                    </select>                                    
                                </div>
                            </div>
                        </div>
