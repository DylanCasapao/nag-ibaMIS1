                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="ddl_tob" class="form-control input-sm">
                                        ...
                                        <option value="Option 1">Printing Services</option>
                                        <option value="Option 2">Sari-Sari Store</option>
                                    </select>                                    
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Amount:</label>
                                    <input name="txt_amount" class="form-control input-sm" type="decimal" value="120.00" placeholder="Amount"/>
                                </div>
                            </div>
                        </div>
