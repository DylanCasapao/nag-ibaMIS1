                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="ddl_pos" class="form-control input-sm">
                                        ...
                                        <option value="Kagawad(Women and Children)">Barangay Kagawad(Women and Children)</option>
                                        <option value="Kagawad(Committee on Appropriations)">Barangay Kagawad(Committee on Appropriations)</option>
                                        <option value="Kagawad(Cooperative)">Barangay Kagawad(Cooperative)</option>
                                        <option value="Kagawad(Environment)">Barangay Kagawad(Environment)</option>
