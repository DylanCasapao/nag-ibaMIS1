        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    ...
                    <?php
                    if($_SESSION['role'] == "Secretary" || isset($_SESSION['staff']))
                    {
                    ?>
                                                ...
                                                if(!isset($_SESSION['staff']))
                                                {
                                                    ...
                                                    while($row = mysqli_fetch_array($squery))
                                                    {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <a target="_blank" href="indigency_form.php?resident='.$row['residentid'].'&indigency='.$row['indigencyNo'].'&val='.base64_encode($row['indigencyNo'].'|'.$row['residentname'].'|'.$row['dateissued']).'" onclick="location.reload();" class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Generate</a></td>
                                                        </tr>
                                                        ';
                                ...
                                <form method="post">
                                 <div class="tab-content">
                                    ...
                                    <table id="table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $squery = mysqli_query($con, "SELECT * FROM tblindigency p left join tblresident r on r.id = p.residentid where r.id = ".$_SESSION['userid']." and status = 'New' ") or die('Error: ' . mysqli_error($con));
