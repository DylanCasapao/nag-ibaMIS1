                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input name="txt_cnum" class="form-control input-sm" type="number" placeholder="Indigency #"/>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Age:</label>
                                    <input name="txt_findings" class="form-control input-sm" type="text" placeholder="age"/>
                                </div>
                                <div class="form-group">
                                    <label>Civil Status:</label>
                                    <input name="txt_purpose" class="form-control input-sm" type="text" placeholder="civilstatus"/>
                                </div>
                                <div class="form-group">
                                    <label>Purpose:</label>
                                    <input name="txt_ornum" class="form-control input-sm" type="text" placeholder="purpose"/>
                                </div>
