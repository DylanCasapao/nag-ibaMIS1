...
<div>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm px-5 py-3 py-lg-0">
        <a href="index.html" class="navbar-brand p-0">
            <h1 class="m-0 text-uppercase text-primary">Management Information System</h1>
        </a>
        ...
        <div class="row g-5">
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-secondary text-center px-5">
                    ...
                    <h3 class="mb-3">Systematized Barangay Record</h3>
                    <p class="mb-0">Keeping Barangay records is a one way to easily track resident’s information.<br>
                     BIMS is capable in recording this bulk information and can be stored in a long period of time.<br>
                     </p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-secondary text-center px-5">
                    ...
                    <p class="mb-0">BMIS also help Barangay Information to be secured with the use of auto-backup database and system user level security preventing unauthorized personnel to access the information.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-secondary text-center px-5">
                    ...
                    <p class="mb-0">Accessible Barangay information system with easy search capabilities and therefore it will be easy to find, retrieve and extract resident’s information.</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="service-item bg-secondary text-center px-5">
