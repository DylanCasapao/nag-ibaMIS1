...
<head>
    <meta charset="utf-8">
    <title>Barangay Nag-iba Management Information System</title>
...
<div>
            ...
            <div class="col-md-6 text-center text-lg-end">
                <div class="position-relative d-inline-flex align-items-center bg-primary text-white top-shape px-5">
                    <div class="me-3 pe-3 border-end py-2">
                        <p class="m-0"><i class="fa fa-envelope-open me-2"></i>barangay.nag-iba2018@gmail.com</p>
                    </div>
                    <div class="py-2">
                        <p class="m-0"><i class="fa fa-phone-alt me-2"></i>09386722248</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow-sm px-5 py-3 py-lg-0">
        <a href="index.html" class="navbar-brand p-0">
            <h1 class="m-0 text-uppercase text-primary" style="position: relative; left: -40px;"></i>Management Information System</h1>
        </a>
        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCollapse">
            <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0 me-n3" style="position: relative; left: -40px;">
                <a href="index.php" class="nav-item nav-link active">Home</a>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Administrator</a>
                <div class="dropdown-menu m-0">
                    <a href="../brgy.nag-iba/login.php" class="dropdown-item">Barangay Captain</a>
                    <a href="../brgy.nag-iba/login.php" class="dropdown-item">Barangay Secretary</a>                        
                </div>
                </div>

                <a href="../brgy.nag-iba/pages/resident/login.php" class="nav-item nav-link">Resident</a>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="img/officials.jpeg" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h5 class=" text-uppercase" style="color: white; font-size: 30px;">Welcome to</h5>
                            <h1 class="display-1 mb-md-4"style="color: white">Barangay Nag-Iba Management Information System</h1>
                            <a href="history.php" class="btn btn-primary py-md-3 px-md-5 me-3 rounded-pill">Barangay History</a>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h1 class="display-4 text-white mb-md-4" >Make your Barangay services and transaction at ease Store, manage and retrieve your records</h1>
                            <a href="/bmis/landing/index.php" class="btn btn-primary py-md-3 px-md-5 me-3 rounded-pill">Barangay History</a>
    ...
    <div class="container-fluid bg-secondary p-0">
        <div class="row g-0">
            <div class="col-lg-6 py-6 px-5">
                <center><h1 class="display-5 mb-4">Welcome To <br> Barangay Nag-iba Management Information System</h1><center>
            ...
            <div class="col-lg-4">
                <div class="team-item position-relative overflow-hidden">
                    ...
                    <div class="team-text w-100 position-absolute top-50 text-center bg-primary p-4">
                        <h3 class="text-white">Wrick Andrei M. Dipasupil</h3>
                        <p class="text-white text-uppercase mb-0">Lead Developer</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="team-item position-relative overflow-hidden">
                    ...
                    <div class="team-text w-100 position-absolute top-50 text-center bg-primary p-4">
                        <h3 class="text-white">Dylan A. Casapao</h3>
                        <p class="text-white text-uppercase mb-0">Associate Developer</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="team-item position-relative overflow-hidden">
                    ...
                    <div class="team-text w-100 position-absolute top-50 text-center bg-primary p-4">
                        <h3 class="text-white">Riza Mae Ilagan</h3>
                        <p class="text-white text-uppercase mb-0">BUHATIN</p>
                    </div>
                </div>
            </div>
        </div>
